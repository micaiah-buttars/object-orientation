...
favoriteThings.book = 'Anything Except Harry Potter'
...
let smaugy = new Cat('Smaug', 8, 'black')

console.log(smaugy.name)
...
let wizard = new Wizard('PicklePee the Destroyer', 89200, 'Tengai Shinsei')
...
let phone1 = new Phone('iPhome', '17S', 2, 'invisible', 1999)
let phone2 = new Phone('Gorgle', 'Voxel', 49, 'petrichor', 40)
let phone3 = new Phone('Sunsmug', 'Universe 10', 19000, 'blue', 899)
...
let myFirstVehicle = new Vehicle(5, 'grey', 40000)
...
let myFirstMotorcycle = new Motorcycle(2,'black',0,'motorcycleBrand',true)
  ...
  constructor(capacity, color, mileage, name, type, isSeaworthy){
    ...
    this.checkSeaworthiness = function(){
      if(this.isSeaworthy === true){
        ...
        console.log(`Fix your stupid ${type}.`)
      }
    }
...
let myFirstBoat = new Boat(1, 'white', 90000000, 'SS Anne', 'yacht', false )
